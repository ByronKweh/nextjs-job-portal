export default function Contact() {
  return (
    <section className="text-gray-400 bg-gray-900 body-font relative h-full align-bottom flex-col flex">
      <div className="fixed h-90 justify-end inset-0 bg-gray-900 align-bottom">
        <iframe
          title="map"
          width="100%"
          height="100%"
      ...
      <div className="container px-5 py-24 mx-auto flex">
        <div className="lg:w-1/3 md:w-1/2 bg-gray-900 shadow-md rounded-lg p-8 flex flex-col md:ml-auto w-full mt-16 md:mt-0 relative z-10">
